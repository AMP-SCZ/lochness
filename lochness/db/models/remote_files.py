...
class RemoteFile:
    ...
    def __init__(
        self, file_path: str, remote_name: str, hash_val: str, last_checked: datetime
    ):
        """
    ...
    def find_matches_by_hash_query(hash_val: str) -> str:
        ...
        """
        sql_query = f"""
        SELECT r_file_path, r_remote_name, r_hash_val, r_last_checked
        FROM remote_files
    ...
    def to_sql(self):
        ...
        sql_query = f"""
            INSERT INTO remote_files (
                r_file_path, r_remote_name, r_hash_val, r_last_checked
            ) VALUES (
                '{file_path}', '{remote_name}', '{hash_val}', '{last_checked}'
